        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              ...
              {{-- <script>
                // Fungsi untuk memuat data dari controller
                function getDataFromController() {
                  return fetch('{{ route("grafik") }}')
                    .then(response => response.json())
                    .then(data => data.datasensor);
                }
            
                // Fungsi untuk mengambil nilai sensor dari data
                function getSensorValues(data) {
                  return data.nilai_temp;
                }
            
                // Fungsi untuk membuat area chart
                function createAreaChart(sensorValue) {
                  var options = {
                    chart: {
                      type: 'area',
                      height: 350
                    ...
                    xaxis: {
                      categories: sensorValue.map((_, index) => `Data ${index + 1}`)
                    }
                  };
                ...
                // Memuat data dari controller dan membuat area chart setelah halaman selesai dimuat
                document.addEventListener("DOMContentLoaded", function() {
                  getDataFromController()
                    .then(getSensorValues)
                    .then(createAreaChart);
                });
              </script> --}}
